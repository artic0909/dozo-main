...
<head>
    ...
    <title>Customer Support | DOZO Admin</title>
    <!-- plugins:css -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">Edit Support</h4>
                    ...
                    <div class="modal-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="c_email" class="form-label">Customer Email ID<span style="color: red;">*</span></label>
                            ...
                            <div class="form-group">
                                <label class="form-check-label" for="c_sub">Subject<span
                                        style="color: red;">*</span></label>
                                <input type="text" name="c_sub" id="c_sub" class="form-control">
                            </div>



                            <div class="form-group">
                                <label for="c_email" class="form-label">Message<span style="color: red;">*</span></label>
                                <textarea name="c_msg" id="c_msg" class="form-control" rows="5"></textarea>
                            </div>
